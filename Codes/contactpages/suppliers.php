...
<form action="suppliers.php" id="search-form" method="get">
...
$searchsql = "SELECT * FROM contacts WHERE designation = 'Supplier' and location LIKE '%$searchTerm%' OR name LIKE '%$searchTerm%'";
