...
<form action="engineer.php" id="search-form" method="get">
...
$searchsql = "SELECT * FROM contacts WHERE designation = 'Engineer' and location LIKE '%$searchTerm%' OR name LIKE '%$searchTerm%'";
