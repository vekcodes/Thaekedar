...
$sql="select * from contacts where designation = 'Architect'";
...
<head>
  ...
  <title>Thaekedar-Architect</title>
...
<form action="architect.php" id="search-form" method="get">
...
$searchsql = "SELECT * FROM contacts WHERE designation = 'Architect' and location LIKE '%$searchTerm%' OR name LIKE '%$searchTerm%'";
