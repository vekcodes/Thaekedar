...
<body>
  <div class="th-nav">
    ...
    <div class="nav-link-div">
        ...
        <a href="agencies.html"><div class="nav-link">Agencies </div></a>
        <div class="dropdown">

          <div class="nav-link" id="peoples">Peoples</div>

          <div class="dropdown-content">
            <a href="interiordesigner.html">Interior Designer</a>
            <a href="architect.html">Architect</a>
            <a href="engineer.html">Engineer</a>
          </div>
        </div>
        <a href="suppliers.html"><div class="nav-link">Suppliers</div></a>
