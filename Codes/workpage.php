...
<body>
  <?php
   ...
   <div class="form-desc">
   <form action="./request/worksubmit.php" method="post">
   ...
   <option value="">---Choose Your Connection---</option>
    ...
    <br>
    <div class="form-desc">
   <label>Work Description</label> <p style="margin: 0; display:inline; font-family: 'reem kufi'; font-size: 13px;">(Max length: 253 words)</p><br>
